"""Regression checks for the plume-move-clock-scope casebook."""
...
from casebook.harness import assert_expected, plume_move_clock_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_move_clock_scope_summary(), assert_expected())
